...
showBitVectorDefault :: BitVector -> String
showBitVectorDefault a = printf "%d'h%x" (width a) (nat a)

showBitVectorConst :: BitVector -> String
showBitVectorConst a = show $ nat a

instance Show Expr where show = showExpr showBitVectorDefault

showExprConst :: Expr -> String
showExprConst = showExpr showBitVectorConst

showExpr :: (BitVector -> String) -> Expr -> String
